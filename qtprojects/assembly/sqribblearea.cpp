...
void ScribbleArea::clickedCircleButton(){
    if(ifCircle) {ifCircle = false; myPenColor = Qt::blue;}
    else { ifCircle = true; myPenColor = Qt::yellow;}
}
void ScribbleArea::clickedArrowButton(){
    if(ifArrow) {ifArrow = false; myPenColor = Qt::blue;}
    else { ifArrow = true; myPenColor = Qt::green;}
